...
Ce site existe pour donner une existence publique à un projet qui en méritait une.
...
## Qu'est-ce qui a changé entre la version des années 2000 et celle d'aujourd'hui ?
...
- **Séries TV → Google Maps** : les décors (les ruines de la côte californienne) peuvent désormais être vérifiés et précisés géographiquement.
- **Imagination seule → IA générative d'images** : les personnages, les lieux et les affiches in-world ont une existence visuelle.

J'ai aussi vu beaucoup d'autres révolutions dans les outils de création — Photoshop, la 3D temps réel, les plateformes VR — et cette accumulation m'a naturellement rendu à l'aise avec la GenAI comme outil artistique.

---

## Qu'est-ce que le monde VRChat associé au projet ?

En parallèle du roman, j'ai développé **La Côte Interdite**, un monde VRChat — un simulateur de marche situé dans *Happy Suburb*, la communauté côtière du roman, à l'époque de l'épisode *L'Émission du Prêcheur*.

Ce monde a été l'occasion de créer de nombreux *assets* visuels in-world : affiches, documents, objets. Ce site existe aussi pour leur donner une visibilité en dehors de la plateforme VRChat, dans la section **Monde**.

---

## Suis-je un auteur ou un worldbuilder ?
...
## Pourquoi utiliser des assistants IA pour écrire ?

Pour les mêmes raisons que j'ai utilisé Photoshop quand il est apparu, ou que j'ai commencé à utiliser Google Maps pour les repérages de décors : c'est un outil qui rend possible ce qui ne l'était pas avant.
...
## Pourquoi ne pas publier sur Wattpad ou une autre plateforme ?
